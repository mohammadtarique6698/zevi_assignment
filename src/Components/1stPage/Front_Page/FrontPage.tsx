...
const FrontPage: React.FC<Color> = ({color}) => {
  ...
  return (
    <div className="front">
      ...
      >
        <Paper style={{ width: "60rem", height: "30rem", display: "flex", flexDirection: "column", paddingLeft: "1rem", paddingRight: "1rem", paddingTop: "1rem", flexShrink: "unset" }}>
          {/* <Typography variant="body1">Latest trend suggestions...</Typography> */}
          <Suggestion />
        </Paper>
      </Popover>
    </div>
